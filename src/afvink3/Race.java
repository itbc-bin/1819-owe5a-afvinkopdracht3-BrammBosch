...
public class Race<paard> extends JFrame implements ActionListener {
    ...
    private void startRace(Graphics g) {
         ...
         * kunt initialiseren.
         */
        h1 = new Paard("Remko",Color.PINK);
        h2 = new Paard("Anneke",Color.red);
        h3 = new Paard("Sara", Color.black);
        h4 = new Paard("Wouter", Color.green);
        h5 = new Paard("Bram", Color.ORANGE);
    ...
    private void tekenPaard(Graphics g, Paard h) {
        ...
        g.fillRect(0, 20 * h.getPaardNummer() ,af, 16);


        try {
            if (h.getPaardNummer() == 1){
                image = ImageIO.read(new File("/home/bram/Desktop/jaar 2/blok_1/afvink3/src/afvink3/mar.gif"));
            }
            else if (h.getPaardNummer() == 4){
                image = ImageIO.read(new File("/home/bram/Desktop/jaar 2/blok_1/afvink3/src/afvink3/pferd.gif"));
            }
            else{
                image = ImageIO.read(new File("/home/bram/Desktop/jaar 2/blok_1/afvink3/src/afvink3/paard.gif"));
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
        g.drawImage(image,af - 16,20*h.getPaardNummer(),this);
    }
